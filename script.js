...
const fetchDataMeteo1 =async() => {
    dataMeteo1 = await fetch(
        `http://api.openweathermap.org/data/2.5/find?lat=-21.001111232791686&lon=55.40057963425958&cnt=50&units=metric&appid=225b127f9ce175b425c3f8eff035e73d`
    ).then(res => res.json());
};
const fetchDataMeteo2 =async() => {
    dataMeteo2 = await fetch(
        `http://api.openweathermap.org/data/2.5/find?lat=-21.225396576857158&lon=55.72431385981477&cnt=50&units=metric&appid=225b127f9ce175b425c3f8eff035e73d`
    ).then(res => res.json());
